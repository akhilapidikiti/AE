...
config_path = '/content/drive/MyDrive/STGRAM/config.yaml'
...
def test(args):
    ...
    with torch.cuda.device(args.device_ids[0]):
        model_path = '/content/drive/MyDrive/model_param/STgram_MFN_ArcFace(m=0.7,s=30)/checkpoint_best.pth.tar'#os.path.join(args.model_dir, args.version, f'checkpoint_best.pth.tar')
